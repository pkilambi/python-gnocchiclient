...
class GnocchiShell(object):
    ...
    def __init__(self):
        self.auth_plugin = gnocchi_client.AuthPlugin()
    ...
    def get_base_parser(self):
        ...
        parser.add_argument('--gnocchi-url', metavar='<GNOCCHI_URL>',
                            dest='os_endpoint',
                            default=cliutils.env('GNOCCHI_URL'),
                            help=("DEPRECATED, use --os-endpoint instead. "
                                  "Defaults to env[GNOCCHI_URL]."))
    ...
    def main(self, argv):
        ...
        client = gnocchi_client.get_client(api_version, **client_kwargs)
...
def main(args=None):
    try:
        ...
        print("Stopping Gnocchi Client", file=sys.stderr)
        sys.exit(130)
